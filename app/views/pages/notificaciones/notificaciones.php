    ...
    <div class="container-notificaciones-usuarios">
        ...
        <div class="container-notificaciones-usuario-revisar">
            <?php foreach($datos['notificaciones'] as $datosNotificacion): ?>
                <a href="<?php echo URL_PROJECT ?>/notificaciones/eliminar/<?php echo $datosNotificacion->idnotificacion ?>" class="link-notificacion mb-1"><div
                class="alert alert-success"><?php echo $datosNotificacion->usuario  . ' ' . $datosNotificacion->mensajeNotificacion?></div></a>
            <?php endforeach ?>
        </div>
    </div>
</div>
